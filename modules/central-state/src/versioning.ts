...
export class Versioning {
   ...
   */
  static createQueryResult<E extends Entity>(
   ...
   */
  static createSingleQueryResult<E extends Entity>(
   ...
   */
  static createPullQueryResult<E extends Entity>(
    entity: EntityWithMetaInfo<E>,
   ...
   */
  static createGetCommandResult<E extends Entity>(
    entity: EntityWithMetaInfo<E>
  ): GetCommandResult<E> {
   ...
   */
  static createMultiValuesCommandResult<E extends Entity>(
    entities: Array<EntityWithMetaInfo<E>>
   ...
   */
  static createPushCommandResult<E extends Entity>(
    entity: EntityWithMetaInfo<E>,
   ...
   */
  static attachMetaInfoToNewEntity<E extends Entity>(
    entity: E
   ...
   */
  static attachMetaInfoToUpdateCommand<
    T extends { operation: UpdateOperation }
  >(command: T): T {
   ...
   */
  static getOperationDiffsByVersion<E extends Entity>(
    entity: EntityWithMetaInfo<E>,
    versionId: string | null | undefined
  ): Array<UpdateOperation> | null | undefined {
   ...
   */
  static getVersionId<E extends Entity>(
    entity: EntityWithMetaInfo<E>
  ): string | null {
   ...
   */
  static getPrevVersionId<E extends Entity>(
    entity: EntityWithMetaInfo<E>
  ): string | null {
    try {
      const metaInfo: EntityMetaInfo = entity._PhenylMeta;
   ...
   */
  static getVersionIds<E extends Entity>(
    entities: Array<EntityWithMetaInfo<E>>
  ): { [entityId: string]: string | null } {
    const versionsById: { [key: string]: string | null } = {};
   ...
   */
  static getPrevVersionIds<E extends Entity>(
    entities: Array<EntityWithMetaInfo<E>>
  ): { [entityId: string]: string | null } {
    const versionsById: { [key: string]: string | null } = {};
