...
import { PhenylSessionClient } from './session-client.js'
 ...
 */
function validWhenDiffsFound(
  command: PushCommand,
  entity: Entity,
  masterOperations: ?Array<UpdateOperation>
) {
...
export class PhenylEntityClient implements EntityClient {
  ...
  constructor(dbClient: DbClient, options: PhenylEntityClientOptions = {}) {
    ...
    this.validatePushCommand =
      options.validatePushCommand || validWhenDiffsFound
  }
